...
This **stm32-stts22h** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **STM32-STTS22H** BSP TEMPERATURE SENSOR component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32-stts22h/blob/main/Release_Notes.html).
